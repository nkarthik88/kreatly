        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              ...
              <div className="text-xs text-orange-200/80">Techno-futurist access</div>
            </div>
          </div>
          <div className="hidden sm:block text-sm text-white/60">Welcome back.</div>
        </header>

        <main className="mt-10 flex flex-1 items-center justify-center">
          <div className="w-full max-w-md">
            <div className="mb-6">
              <h1 className="text-3xl font-bold tracking-[-0.02em]">Log in</h1>
              <p className="mt-2 text-sm text-white/70">
                Welcome back to your Notion-powered publishing workflow.
              </p>
            </div>
